"""
Vollständige Korrelationsanalyse: Big5 und GAAIS mit SUMMEN-Variablen
"""
import pandas as pd
import numpy as np
...
# Daten laden
log("=" * 80)
log("VOLLSTÄNDIGE KORRELATIONSANALYSE: BIG5 UND GAAIS (SUMMEN-VARIABLEN)")
log("=" * 80)
...
# ============================================================================
log("\n" + "=" * 80)
log("3. VOLLSTÄNDIGE KORRELATIONSMATRIX (Pearson r)")
log("=" * 80)
...
# ============================================================================
log("\n" + "=" * 80)
log("4. SPEARMAN RANGKORRELATIONEN (robuster bei Nicht-Normalverteilung)")
log("=" * 80)
...
for big5 in big5_vars:
    for gaais in gaais_vars:
        ...
        log(f"\n{big5} ↔ GAAIS_{gaais_name}:")
        log(f"  ρ = {rho:.3f}, p = {p:.4f} {sig}")

# ============================================================================
# 5. ÜBERSICHTSTABELLE FÜR PUBLIKATION
# ============================================================================
log("\n" + "=" * 80)
log("5. ÜBERSICHTSTABELLE (für wissenschaftliche Arbeit)")
log("=" * 80)
...
# ============================================================================
log("\n" + "=" * 80)
log("6. KORRELATION ZWISCHEN GAAIS-SUBSKALEN")
log("=" * 80)
...
# ============================================================================
log("\n" + "=" * 80)
log("7. ZUSAMMENFASSUNG DER SIGNIFIKANTEN BEFUNDE")
log("=" * 80)
...
# In Datei speichern
with open('analyse_summen_output.txt', 'w', encoding='utf-8') as f:
    f.write('\n'.join(output_lines))
